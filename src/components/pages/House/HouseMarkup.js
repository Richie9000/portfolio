    ...
    <div style={{width: "100%", height:"100%"}}>
      <Breakpoint large up >
        ...
        <h1 style={{margin:"20px", marginTop: "20px", fontSize:"24px"}}>NFT created for Decentraland Metaverse</h1>
          ...
          <div className="containerhouse" style={{ display: "flex", justifyContent: "center", width:"100%", height:"72vh" } }>
        <Canvas camera={{ fov: 70, position: [ 28, 0, -20 ]}} style={{ width:"90%", height: "63vh" } }>
      ...
      <footer style={{ margin:"20px",fontSize: '1.2em', fontWeight: 500, letterSpacing: '-0.05em', lineHeight: "1.5em" }}>
